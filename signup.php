...
$error = ""; // Define $error before usage
...
<body class="bg-gray-100 text-gray-800">
  ...
  <div class="flex items-center justify-center min-h-screen px-4">
    <div class="w-full max-w-md p-8 bg-white rounded-xl shadow-lg">
      <h2 class="text-2xl font-bold mb-6 text-green-700 text-center">Create Your Account</h2>
      <?php if (!empty($error)): ?>
      ...
      <form method="POST" class="space-y-4">
        ...
        <div>
          ...
          <input type="tel" id="mobile" name="mobile" required class="w-full border border-gray-300 rounded-lg px-4 py-2" />
        </div>
        <div>
        ...
        <div>
          <button type="submit" class="w-full bg-green-600 text-white font-bold py-2 rounded-lg hover:bg-green-700">Sign Up</button>
        </div>
      </form>
